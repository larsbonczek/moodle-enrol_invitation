...
$string['allowmismatchingemails'] = 'Allow accepting invitations with mismatching email addresses';
$string['allowmismatchingemails_desc'] = 'Enable this to allow users to accept invitations even if the invitation was sent to a different email address than the one associated with the user\'s account. This only applies to invitations sent to unregistered users. Invitations sent to registered users can only ever be accepted by the user they were sent to.';
...
$string['mismatchingemail_notice'] = 'Warning: The email address that the invitation was sent to does not match your user account. Please only accept this invitation if it was meant for you.';
